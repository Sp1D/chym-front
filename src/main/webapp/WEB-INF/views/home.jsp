...
<html>
    <head>
                        ...
                        <form id="settings"> 
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="s" id="size" title="Movies count on page">                                        
                                    <c:forEach begin="10" end="30" step="5" var="option">
        ...
        <!-- Pages bar -->
        <c:forEach var="mov" items="${testlist}">
            <c:out value="${mov.title}">, </c:out><br>
        </c:forEach>
            ...
            <ul class="pagination">
                ...
                <c:forEach var="currentPage" begin="1" end="${pagesTotal}" step="1">
                    <li><a href="<c:url value="" >
                           ...
                           </c:url>"><c:out value="${currentPage}"/></a></li>
            ...
            <div class="row">
                <c:forEach var="movie" items="${MovieFullList}" begin="${(currentRow-1)*cols}" end="${currentRow*cols-1}">
                    <div class="col-lg-2 col-md-4 col-sm-6">                                        
                        ...
                        <div class="" ><a href="<c:url value="/episodes/${movie.getImdbID()}"/>"><img  class="poster" src="<c:url value="${movie.getPoster()}"/>" alt="<c:out value="${movie.getTitle()}" />"></a></div>
                        <div class="btn-group">
