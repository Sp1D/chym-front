                    ...
                    <form:form action="login" method="post" modelAttribute="user">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <span style="color:#d9534f;"><c:if test="${userNotExists}">Such user is not exists</c:if></span>
                                <span style="color:#d9534f;"><c:if test="${passwordMismatch}">Password mismatch</c:if></span>
                            </div>
                            <div class="form-group">                                
